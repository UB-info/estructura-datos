...
class MainApp(Tkinter.Tk):  # inherit from Tk makes view handling cleaner
    def __init__(self, parser, add, search, remove, users, *args, **kwargs):
        ...
        self.frmButtons.grid(row=1, column=1, padx=(0, 5), pady=(5, 0), columnspan=3)
    ...
    def add(self):
        ...
        self.users, time = benchmark(lambda: self._add(self._parser))
