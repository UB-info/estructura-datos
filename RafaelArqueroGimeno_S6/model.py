...
from HEAP_Rafael_Arquero_Gimeno import Heap
from HASH_Rafael_Arquero_Gimeno import Hash
...
class User:
    ...
    def __cmp__(self, other):
        return cmp(self.__relevance, other.relevance) if isinstance(other, User) else cmp(self.__relevance, other)

    def __hash__(self):
        return hash(self.__relevance)
